...
<section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default color-palette-box">
          ...
          <div class="card-body">
            <div class="col-12">
            <table  class="table table-striped table-bordered datatable" json-url="{{ url('admin/get_json/category') }}" data-url="{{ url('admin/get_blogcategory') }}" style="width:100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Category Name</th>
...
<div class="modal" id="addNewRole">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form data-pop="#addNewRole" action="{{ url('admin/blogcategory_manage_operation/') }}" class="database_operation_form">
        <div class="">
            <div class="mb-3">
...
<div class="modal" id="update_cat_popup">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
      <form data-pop="#update_cat_popup" action="{{ url('admin/blogcategory_manage_operation/') }}" class="database_operation_form">
        <div class="">
            <div class="mb-3">
                <label  class="form-label">Enter Category Name</label>
                <div>
