...
<section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default color-palette-box">
          ...
          <div class="card-body">
            <div class="col-12">
            <table  class="table table-striped table-bordered datatable" json-url="{{ url('admin/get_json/category') }}" data-url="{{ url('admin/products/get_metal') }}" style="width:100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Metal Name</th>
...
<div class="modal" id="addNewRole">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form data-pop="#addNewRole" action="{{ url('admin/products/metal_manage_operation/') }}" class="database_operation_form">
        <div class="">
            <div class="mb-3">
                <label  class="form-label">Enter Metal Name</label>
                <div>
                    {{ csrf_field() }}
...
<div class="modal" id="design_style_popup">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
      <form data-pop="#design_style_popup" action="{{ url('admin/products/metal_manage_operation/') }}" class="database_operation_form">
        <div class="">
            <div class="mb-3">
                <label  class="form-label">Enter Metal Name</label>
                <div>
